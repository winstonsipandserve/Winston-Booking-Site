...
- **6:00 AM – 10:00 PM daily**, uniform across every resource type. A booking must start and end on the same Manila calendar day, so no booking can run past midnight.
