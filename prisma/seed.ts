import {
  ...
  AddOnServiceSlug,
  BulletinCategory,
  BulletinBookingImpact,
  BulletinCustomerAction,
  BulletinCustomerEligibility,
} from '@prisma/client'
...
async function main() {
  ...
  // Sample bulletins are keyed by title/category so this block can be rerun without
  // duplicating rows. The [Sample] prefix makes them easy to identify and remove in a
  // development database without affecting staff-created announcements.
  const sampleAnnouncements = [
    {
      title: '[Sample] Tennis Court Refresh',
      excerpt: 'Tennis Court 1 will receive a fresh surface and lighting improvements.',
      body: 'We are refreshing Tennis Court 1 to make every rally more comfortable and consistent. The court will be unavailable while the work is underway.',
      category: BulletinCategory.Renovation,
      imageUrl: '/images/facilities/tennis-courts.jpg',
      affectedFacility: 'Tennis Court 1',
      impact: 'Tennis Court 1 will be unavailable during the renovation window.',
      action: 'Please reserve a pickleball court or tennis simulator for sessions during this period.',
      bookingImpact: BulletinBookingImpact.LimitedAvailability,
      customerActionType: BulletinCustomerAction.BookAnotherFacility,
      eventStartAt: daysFromNow(7),
      eventEndAt: daysFromNow(14),
      expiresAt: daysFromNow(21),
      ctaLabel: null,
      ctaUrl: null,
      isPublished: true,
      publishedAt: now,
      autoDisableResources: false,
    },
    {
      title: '[Sample] Café & Bar Private Closure',
      excerpt: 'The café and bar will be closed for a private function on Saturday evening.',
      body: 'Our café and bar team will be hosting a private function. The sports facilities remain open, but café and bar service will pause during the closure window.',
      category: BulletinCategory.Closure,
      imageUrl: null,
      affectedFacility: 'Café & Bar',
      impact: 'Food, beverage, and lounge service will not be available during the private function.',
      action: 'Please plan café orders before the closure or return after service resumes.',
      bookingImpact: BulletinBookingImpact.NoImpact,
      customerActionType: BulletinCustomerAction.WaitForFurtherNotice,
      eventStartAt: daysFromNow(10),
      eventEndAt: daysFromNow(10.5),
    ...
    {
      title: '[Sample] Winston Open Pickleball Cup',
      excerpt: 'Join our friendly weekend pickleball tournament for all skill levels.',
      body: 'The Winston Open brings our pickleball community together for a weekend of friendly competition, doubles play, and post-match refreshments.',
      category: BulletinCategory.Tournament,
      imageUrl: '/images/facilities/pickleball-courts.jpg',
      affectedFacility: 'Pickleball Courts',
      impact: 'Some pickleball courts will have limited availability during tournament matches.',
      action: 'Register your interest early and choose another facility if your preferred court is occupied.',
      bookingImpact: BulletinBookingImpact.LimitedAvailability,
      customerActionType: BulletinCustomerAction.ContactSupport,
      eventStartAt: daysFromNow(18),
      eventEndAt: daysFromNow(20),
      expiresAt: daysFromNow(22),
      ctaLabel: 'Register Interest',
      ctaUrl: 'https://example.com/winston-open',
      isPublished: true,
      publishedAt: now,
      autoDisableResources: false,
    },
    {
      title: '[Sample] Rally, Roast & Connect',
      excerpt: 'Meet fellow players at an open community evening with casual games and café treats.',
      body: 'Bring a friend, play a few relaxed games, and enjoy an evening of good company at Winston Sip and Serve. Everyone is welcome, whether you are new to the sport or a regular on court.',
      category: BulletinCategory.Community,
      imageUrl: '/images/facilities/cafe-bar.jpg',
      affectedFacility: 'Pickleball Courts & Café',
      impact: 'Regular bookings continue as normal, with a small community gathering in the café area.',
      action: 'No booking changes are needed; drop in during the event window and introduce yourself.',
      bookingImpact: BulletinBookingImpact.NoImpact,
      customerActionType: BulletinCustomerAction.NoActionRequired,
      eventStartAt: daysFromNow(25),
      eventEndAt: daysFromNow(25.5),
      expiresAt: daysFromNow(27),
      ctaLabel: 'Learn More',
      ctaUrl: 'https://example.com/community-night',
      isPublished: true,
      publishedAt: now,
      autoDisableResources: false,
    },
    {
      title: '[Sample] Extended Evening Hours',
      excerpt: 'We are testing extended Friday hours for evening games and café visits.',
      body: 'Starting this week, Winston Sip and Serve will stay open later on Fridays as we test a new evening schedule. We will share a permanent schedule after the trial period.',
      category: BulletinCategory.General,
      imageUrl: null,
      affectedFacility: 'Entire facility',
      impact: 'Friday operating hours will be extended during the trial period.',
      action: 'Check the booking calendar for available evening slots before visiting.',
      bookingImpact: BulletinBookingImpact.NoImpact,
      customerActionType: BulletinCustomerAction.NoActionRequired,
      eventStartAt: daysFromNow(-1),
      eventEndAt: null,
      expiresAt: null,
      ctaLabel: null,
      ctaUrl: null,
    ...
    {
      title: '[Sample] Golf Simulator Calibration',
      excerpt: 'Golf Simulator Bay 2 will be offline briefly for routine calibration.',
      body: 'Our technicians will calibrate Golf Simulator Bay 2 to keep launch data and tracking accurate. The other golf simulator bay and courts remain available.',
      category: BulletinCategory.FacilityMaintenance,
      imageUrl: null,
      affectedFacility: 'Golf Simulator Bay 2',
      impact: 'Golf Simulator Bay 2 will be temporarily unavailable during the maintenance window.',
      action: 'Book Golf Simulator Bay 1 or another facility if you need a session during this period.',
      bookingImpact: BulletinBookingImpact.TemporarilyUnavailable,
      customerActionType: BulletinCustomerAction.BookAnotherFacility,
      eventStartAt: daysFromNow(5),
      eventEndAt: daysFromNow(5.25),
    ...
    {
      title: '[Sample] Serve & Sip Court Offer',
      excerpt: 'Enjoy 20% off eligible court bookings during this limited-time offer.',
      body: 'For a limited time, everyone can enjoy our Serve & Sip offer on eligible court bookings. This promotion is informational; staff will confirm the applicable rate when you book.',
      category: BulletinCategory.Promotion,
      imageUrl: null,
      affectedFacility: null,
      impact: null,
      action: null,
      bookingImpact: BulletinBookingImpact.NoImpact,
      customerActionType: BulletinCustomerAction.NoActionRequired,
      promoCode: 'SERVE20',
      discountSummary: '20% off eligible court bookings',
      customerEligibility: BulletinCustomerEligibility.Everyone,
      eventStartAt: daysFromNow(1),
      eventEndAt: daysFromNow(30),
  ...
  for (const announcement of sampleAnnouncements) {
    const existing = await prisma.bulletin.findFirst({
      where: { title: announcement.title, category: announcement.category },
    ...
    if (existing) {
      await prisma.bulletin.update({
        ...
        data: { ...announcement, publishedAt: existing.publishedAt ?? now },
      })
    } else {
      await prisma.bulletin.create({ data: announcement })
    }
  }
}
