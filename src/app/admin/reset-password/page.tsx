  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 font-sans dark:bg-gray-950">
      ...
      <div className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Choose a new password for your admin account.</p>
        <Suspense fallback={<p className="mt-6 text-sm text-gray-500 dark:text-gray-400">Loading…</p>}>
