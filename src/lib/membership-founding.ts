...
// Winston Premier activations pay ₱5,000 for life. Founding status is a flag on the
// membership, never a tier (docs/decisions.md).
//
...
// unpaid Founding payment still inside its link lifetime, so two applicants cannot both be
// sold the last seat while one of them is still at checkout. Once a customer holds Founding
// status, every later Premier payment of theirs is Founding-priced without consuming a seat.
