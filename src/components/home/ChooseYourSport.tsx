      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-3 lg:grid-cols-5">
          {resourceTypes.map((rt, index) => (
            <Reveal key={rt.id} delayMs={index * 100}>
              <div className="overflow-hidden rounded-2xl bg-white shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-hero">
