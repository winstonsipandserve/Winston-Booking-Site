  ...
  return (
    <div className="mt-8 inline-flex rounded-full border border-brand-light/25 bg-brand-light/5 p-1">
      <button
        ...
        className={`rounded-full px-6 py-2 text-sm font-medium uppercase tracking-wide transition-colors duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-light ${
